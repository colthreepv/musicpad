module.exports = function ( grunt ) {
  ...
  grunt.initConfig({
    ...
    delta: {
      ...
      src: {
        ...
        tasks: [ 'jshint:src', 'karma:unit:run', 'concat:dist', 'ngmin:dist', 'uglify:dist', 'delta' ]
      },
   ...
   */
  grunt.registerTask( 'quick-build', ['clean', 'html2js', 'jshint', 'karma:unit', 'concat', 'recess', 'index', 'copy'] );
